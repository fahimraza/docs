...
(function ($, api)
{
    ...
    function appendSlideoutDom(socialNetwork)
    {
        ...
        var rawDom = "<div id='ej-plugin-socialslideout' class='" + (api.Settings.showPoweredBy ? " ej-ss-with-powered-by" : "") + "'><div class='ejp-ss-top-box ejp-ss-" + socialNetwork.toLowerCase() + "'> <p><a href='JavaScript:void(0)' id='ej-plugin-socialslideout-close'>" + api.Settings.dontShowAgainText + " | <strong>X</strong></a></p><h3>{!mainDescription}</h3><p class='ej-ss-description'>{!subDescription}</p></div><div class='ej-ss-slider-photo'>{!sliderImage}</div><div class='ejp-ss-btn-container ejp-ss-" + socialNetwork.toLowerCase() + "'>" + (domTemplates.length ? "" : NetworkDomFunctions[socialNetwork](socialNetworkProfile)) + "</div>" + (api.Settings.showPoweredBy ? "<div class='ej-ss-powered-by ejp-ss-" + socialNetwork.toLowerCase() + "'><a href='" + api.Settings.poweredByLink + "' target='_blank'>Powered By Social Slider &raquo;</a></div>" : "") + "</div>";
